      ...
      >
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3 text-gray-400">
            <Mail /> <span>ravichandra.devops2025@gmail.com</span>
          </div>
          <div className="flex items-center gap-3 text-gray-400">
          ...
          <div className="mt-10 space-y-4">
            ...
            <ul className="text-sm space-y-4 text-gray-300">
              <li>
                <a href="/resume.pdf" download className="hover:text-teal-400">
                  <FileDown size={14} className="inline mr-1" />
                  Download Resume
                </a>
              </li>
              <li>
                <a href="mailto:ravichandra.devops2025@gmail.com" className="hover:text-teal-400">
                  <Mail size={14} className="inline mr-1" />
                  Send Email
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/ravichandravajinepalli/" target="_blank" className="hover:text-teal-400" rel="noopener noreferrer">
                  <Linkedin size={14} className="inline mr-1" />
                  LinkedIn Profile
                </a>
              </li>
              <li>
                <a href="https://github.com/ravichandradevops2025" target="_blank" className="hover:text-teal-400" rel="noopener noreferrer">
        ...
        {/* Contact Form */}
        <form action="https://formsubmit.co/ravichandra.devops2025@gmail.com" method="POST" className="space-y-4">
